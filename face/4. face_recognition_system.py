...
unknown_image = face_recognition.load_image_file("img/people_1.jpg")
# unknown_image = face_recognition.load_image_file("img/people_2.jpg")
# unknown_image = face_recognition.load_image_file("img/unknown_4.jpg")


# Get face encodings for any people in the picture
# For images with lower resolution than other images, it may require upsampling 
